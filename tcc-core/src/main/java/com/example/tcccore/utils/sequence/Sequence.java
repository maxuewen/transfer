...
import com.example.tcccore.properties.PropertiesConfig;

/**
 * 唯一id生成器，http://git.oschina.net/yu120/sequence
 *
 * Created by MaXuewen on 2017/9/15.
 */
public class Sequence {
  ...
  public Sequence() {
    PropertiesConfig config = SpringContextUtil.getBean(PropertiesConfig.class);

    this.datacenterId = config.getDataCenterId();
    this.workerId = config.getWorkId();
  }
